...
async def ai_check(text, mode="is_seeker"):
    ...
    try:
        if mode == "is_seeker":
            sys_prompt = "Ты учитель по арбитражу и наставник по обучению трейдинга на биржах ищешь лиды и клиентов. Ответь ДА, только если человек САМ ищет обучение, торговлю, сигналы, дополнительный доход. НЕТ — если это вакансия, реклама услуг или спам."
        else:
